...
dados_dsa = [("Banana", 1000, "Equador"), ("Cenoura", 1500, "Equador"), ("Arroz", 1600, "Equador"),
             ("Laranja", 2000, "Equador"), ("Laranja",
                                            2000, "Equador"), ("Banana", 400, "Portugal"),
             ("Cenoura", 1200, "Portugal"), ("Arroz", 1500,
                                             "Portugal"), ("Laranja", 4000, "Portugal"),
...
unPivotDF = pivotDF.select("Produto", expr(
    unpivotExpr)).where("Total is not null")
