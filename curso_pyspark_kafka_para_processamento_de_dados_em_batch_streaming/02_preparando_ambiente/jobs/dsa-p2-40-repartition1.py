...
print("Número Padrão de Partições Definindo Pelo Spark: " +
      str(df.rdd.getNumPartitions()))
...
print("Número de Partições Após Modificar o Parâmetro do Spark: " +
...
print("Número de Partições Após o Reparticionamento: " +
      str(rdd2.getNumPartitions()))
...
print("Número de Partições Após o Reparticionamento com Coalesce: " +
      str(rdd3.getNumPartitions()))
