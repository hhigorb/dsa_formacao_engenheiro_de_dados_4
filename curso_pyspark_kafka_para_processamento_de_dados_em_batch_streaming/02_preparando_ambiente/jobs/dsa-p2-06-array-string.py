...
df2 = df.withColumn("linguagemMaisUsada", concat_ws(
    ",", col("linguagemMaisUsada")))
...
spark.sql("select nome, concat_ws(',',linguagemMaisUsada) as linguagemMaisUsada, estado from ARRAY_STRING").show(
    truncate=False)
